...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostChurch.name'
        db.add_column(u'events_hostchurch', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Golgota', max_length=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostChurch.name'
        db.delete_column(u'events_hostchurch', 'name')
