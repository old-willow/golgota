...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'gallery_gallery', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Gallery.is_publishable'
        db.add_column(u'gallery_gallery', 'is_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Gallery.description'
        db.alter_column(u'gallery_gallery', 'description', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True))

    def backwards(self, orm):
        # Deleting field 'Gallery.slug'
        db.delete_column(u'gallery_gallery', 'slug')

        # Deleting field 'Gallery.is_publishable'
        db.delete_column(u'gallery_gallery', 'is_publishable')


        # Changing field 'Gallery.description'
        db.alter_column(u'gallery_gallery', 'description', self.gf('django.db.models.fields.TextField')(default='', max_length=2000))
    ...
    models = {
        ...
        u'gallery.image': {
            ...
            'date_uploded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
