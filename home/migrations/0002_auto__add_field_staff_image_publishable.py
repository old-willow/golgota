...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Staff.image_publishable'
        db.add_column(u'home_staff', 'image_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Staff.image_publishable'
        db.delete_column(u'home_staff', 'image_publishable')
