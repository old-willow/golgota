...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Staff.fb_profile'
        db.add_column(u'home_staff', 'fb_profile',
                      self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.fb_publishable'
        db.add_column(u'home_staff', 'fb_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Staff.mob_phone_publishable'
        db.add_column(u'home_staff', 'mob_phone_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Staff.phone_publishable'
        db.add_column(u'home_staff', 'phone_publishable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Staff.fb_profile'
        db.delete_column(u'home_staff', 'fb_profile')

        # Deleting field 'Staff.fb_publishable'
        db.delete_column(u'home_staff', 'fb_publishable')

        # Deleting field 'Staff.mob_phone_publishable'
        db.delete_column(u'home_staff', 'mob_phone_publishable')

        # Deleting field 'Staff.phone_publishable'
        db.delete_column(u'home_staff', 'phone_publishable')
