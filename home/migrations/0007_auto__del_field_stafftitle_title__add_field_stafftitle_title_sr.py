...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StaffTitle.title'
        db.delete_column(u'home_stafftitle', 'title')

        # Adding field 'StaffTitle.title_sr'
        db.add_column(u'home_stafftitle', 'title_sr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StaffTitle.title'
        db.add_column(u'home_stafftitle', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Deleting field 'StaffTitle.title_sr'
        db.delete_column(u'home_stafftitle', 'title_sr')
    ...
    models = {
        ...
        u'home.stafftitle': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title_sr': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        u'home.weekday': {
