...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaffTitle.title_hu'
        db.add_column(u'home_stafftitle', 'title_hu',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaffTitle.title_en'
        db.add_column(u'home_stafftitle', 'title_en',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaffTitle.title_hu'
        db.delete_column(u'home_stafftitle', 'title_hu')

        # Deleting field 'StaffTitle.title_en'
        db.delete_column(u'home_stafftitle', 'title_en')
