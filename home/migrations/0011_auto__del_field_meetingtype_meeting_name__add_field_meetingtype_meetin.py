...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MeetingType.meeting_name'
        db.delete_column(u'home_meetingtype', 'meeting_name')

        # Adding field 'MeetingType.meeting_name_sr'
        db.add_column(u'home_meetingtype', 'meeting_name_sr',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeetingType.meeting_name_hu'
        db.add_column(u'home_meetingtype', 'meeting_name_hu',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeetingType.meeting_name_en'
        db.add_column(u'home_meetingtype', 'meeting_name_en',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MeetingType.meeting_name'
        db.add_column(u'home_meetingtype', 'meeting_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MeetingType.meeting_name_sr'
        db.delete_column(u'home_meetingtype', 'meeting_name_sr')

        # Deleting field 'MeetingType.meeting_name_hu'
        db.delete_column(u'home_meetingtype', 'meeting_name_hu')

        # Deleting field 'MeetingType.meeting_name_en'
        db.delete_column(u'home_meetingtype', 'meeting_name_en')
    ...
    models = {
        ...
        u'home.meetingtype': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meeting_name_en': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'meeting_name_hu': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'meeting_name_sr': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
        u'home.regularmeeting': {
            ...
            'meeting_type': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'to': u"orm['home.MeetingType']", 'null': 'True', 'blank': 'True'}),
